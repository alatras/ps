...
func (_Plasma *PlasmaCaller) Token(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Plasma.contract.Call(opts, out, "token")
	return *ret0, err
}
...
//
// Solidity: function token() constant returns(address)
func (_Plasma *PlasmaSession) Token() (common.Address, error) {
	return _Plasma.Contract.Token(&_Plasma.CallOpts)
}

// Token is a free data retrieval call binding the contract method 0xfc0c546a.
//
// Solidity: function token() constant returns(address)
func (_Plasma *PlasmaCallerSession) Token() (common.Address, error) {
	return _Plasma.Contract.Token(&_Plasma.CallOpts)
}
...
//
// Solidity: function deposit(address owner, uint256 amount) returns()
func (_Plasma *PlasmaTransactor) Deposit(opts *bind.TransactOpts, owner common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Plasma.contract.Transact(opts, "deposit", owner, amount)
}

// Deposit is a paid mutator transaction binding the contract method 0x47e7ef24.
//
// Solidity: function deposit(address owner, uint256 amount) returns()
func (_Plasma *PlasmaSession) Deposit(owner common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Plasma.Contract.Deposit(&_Plasma.TransactOpts, owner, amount)
}

// Deposit is a paid mutator transaction binding the contract method 0x47e7ef24.
//
// Solidity: function deposit(address owner, uint256 amount) returns()
func (_Plasma *PlasmaTransactorSession) Deposit(owner common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Plasma.Contract.Deposit(&_Plasma.TransactOpts, owner, amount)
}
